...
- 530 Hz 映射为 75% 占空比；
- 中间频率线性映射；
- 声音太小、没有稳定音调，或频率超出范围时，输出 0% 占空比，电机停止。

该默认范围面向人声蒙古长调：它覆盖多数男声约 70–300 Hz 和女声约 150–500 Hz 的基频范围，并将最高输出设为 75%。自相关测频比简单零交叉法更能抵抗人声的泛音；频率经 87.5/12.5 低通平滑后再控制 PWM，连续三帧无法识别前会暂时保持上一次转速，避免短暂误判造成电机停转。若电机在 10% 时无法起转，可在 `menuconfig` 中提高最小占空比。
